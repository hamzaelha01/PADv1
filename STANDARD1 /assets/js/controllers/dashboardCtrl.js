 ...
 */
app.controller('SparklineCtrl', ["$scope", "user", "personnel", function($scope, user, personnel) {
    ...
    // $scope.userC = user.getName();
    $scope.userC = user.profil();
    $scope.userR = user.getRole();
    // $scope.PersonnelC = personnel.getNomPersonnel();
    $scope.dat = user;
    // intermediaire entre LoginCtrl et Dashboard 
    $scope.ser = function($scope, user) {
            $scope.dataSrvc = user
        }
        // $scope.ser = user.getPerm();
}]);
