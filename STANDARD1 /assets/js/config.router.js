...
app.config(['$stateProvider', '$urlRouterProvider', '$controllerProvider', '$compileProvider', '$filterProvider', '$provide', '$ocLazyLoadProvider', 'JS_REQUIRES',
    function($stateProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $ocLazyLoadProvider, jsRequires) {
        ...
        $stateProvider.state('app', {
                ...
                resolve: {
                    check: function($window, user, personnel) {
                        if (!user.isUserLoggedIn()) // for Clients 
                        // if (!personnel.isPersonnelLoggedIn())
                        // if (!user.getRole() == "Perso")  // for Roles 
                        {
                            //|| !user.getRole() == "Perso"
                            // $window.location.href = '#/login/signin';
                ...
                resolve: {
                    check: function($window, user) {
                        // if (!user.isUserLoggedIn()) // for Clients 
                        if (!user.isUserLoggedIn() | user.getRole() != "Service Clients") // for Clients 
                        // if (!personnel.isPersonnelLoggedIn())
                        // if (!user.getRole() == "Perso")  // for Roles 
                        {
                            //|| !user.getRole() == "Perso"
                    ...
                    scripts: loadSequence('jquery-sparkline', 'touchspin-plugin', 'dynamicTableCtrl', 'user').deps
                },
                ...
                resolve: {
                    check: function($window, user) {
                        // if (!user.isUserLoggedIn()) // for Clients 
                        if (!user.isUserLoggedIn() | user.getRole() != "Client") // for Clients 
                        // if (!personnel.isPersonnelLoggedIn())
                        // if (!user.getRole() == "Perso")  // for Roles 
                        {
                            //|| !user.getRole() == "Perso"
                ...
                resolve: {
                    check: function($window, user) {
                        // if (!user.isUserLoggedIn()) // for Clients 
                        if (!user.isUserLoggedIn() | user.getRole() != "Service Production") // for Clients 
                        // if (!personnel.isPersonnelLoggedIn())
                        // if (!user.getRole() == "Perso")  // for Roles 
                        {
                            //|| !user.getRole() == "Perso"
                    ...
                    scripts: loadSequence('moment', 'dynamicTableCtrl', 'mwl.calendar', 'calendarCtrl', 'user').deps
                },
                ...
                resolve: {
                    check: function($window, user) {
                        // if (!user.isUserLoggedIn()) // for Clients 
                        if (!user.isUserLoggedIn() | user.getRole() != "livreur") // for Clients 
                        // if (!personnel.isPersonnelLoggedIn())
                        // if (!user.getRole() == "Perso")  // for Roles 
                        {
                            //|| !user.getRole() == "Perso"
                    ...
                    scripts: loadSequence('moment', 'dynamicTableCtrl', 'mwl.calendar', 'LivreurCtrl', 'user').deps
                },
        ...
        .state('app.logout', {
            ...
            templateUrl: '',
            resolve: {
                deadResvole: function($location, user) {
                    user.dataClear();
                    $location.path('/');
