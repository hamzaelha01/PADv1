...
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        'LivreurCtrl': 'assets/js/controllers/LivreurCtrl/LivreurCtrl.js',
        'MyCtrl': 'assets/js/controllers/MyCtrl/MyCtrl.js',
        'ClientCtrl': 'assets/js/controller/ClientCtrl/ClientCtrl.js',
        //*** Filters
        'htmlToPlaintext': 'assets/js/filters/htmlToPlaintext.js',
        'LoginCtrl': 'assets/js/controller/LoginCtrl.js',
        'user': 'assets/js/directives/user.js',
        'personnel': 'assets/js/directives/personnel.js'
    },
    //*** angularJS Modules
    modules: [{
        name: 'angularMoment',
