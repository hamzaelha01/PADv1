...
if(count($_POST)>0) {
	...
	$result = mysqli_query($conn,"SELECT DISTINCT COMMANDE.ID_COMMANDE , COMMANDE.DD_COMMANDE ,COMMANDE.STATUS, COMMANDE.DF_COMMANDE , SUM(PANIER.QUANITE) as QUANTITE , SUM(PANIER.MONTANT)as MONTANT , LOCALISATION.Adresse_Complete_Collect 
