...
//$query  ="INSERT INTO `CLIENT` ( `NOM_CLIENT`, `PRENOM_CLIENT`, `TELEPHONE_CLIENT`, `Email`,  `Password`) VALUES ( '$nom', '$prenom', '$tel', '$email', '$mdp')";
$query ="INSERT INTO `CATEGORIE` (`ID_CATEGORIE`, `DESGINATION_CAT`) VALUES (NULL, '$nom')";
